...
create_model_layout = dbc.Container(
    [
        ...
        dbc.Row([dbc.Col(html.Label("Минимальное число признаков")),dbc.Col(html.Label("Максимальное число признаков"))]),
        dbc.Row([
        ...
        dbc.Row([dbc.Col(html.Label("Минимальное значение признака")),dbc.Col(html.Label("Максимальное значение признака"))]),
        dbc.Row([
        ...
        dbc.Row([dbc.Col(html.Label("Минимальное число периодов")),dbc.Col(html.Label("Максимальное число периодов"))]),
        dbc.Row([
        ...
        dbc.Row([dbc.Col(html.Label("Минимальная продолжительность периода")),dbc.Col(html.Label("Максимальная продолжительность периода"))]),
        dbc.Row([
        ...
        dbc.Row([dbc.Col(html.Label("Минимальное значение периода")),dbc.Col(html.Label("Максимальное значение периода"))]),
        dbc.Row([
        ...
        dbc.Row([dbc.Col(html.Label("Минимальное число классов")),dbc.Col(html.Label("Максимальное число классов"))]),
        dbc.Row([
        ...
        dbc.Row([dbc.Col(html.Label("Минимальное число признаков в классе")),dbc.Col(html.Label("Максимальное число признаков в классе"))]),
        dbc.Row([
